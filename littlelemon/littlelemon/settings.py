...
SECRET_KEY = 'django-insecure-(#0y10=2h=%$i*b)12x!kj&94so4qh%d_g4(pftx$x^dj7l&0j'
...
DJOSER={"USER_ID_FIELD":"username"} # create new user programmatically.
...
TEMPLATES = [
    {
        ...
        # 'DIRS': ["templates"],#added tempaltes
